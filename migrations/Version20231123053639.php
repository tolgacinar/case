 ...
 */
final class Version20231123053639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD provider_id INT NOT NULL, DROP provider');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD provider BIGINT NOT NULL, DROP provider_id');
    }
}
